...
namespace TestProject.Controllers
{
    [ApiController]
    [Route("[controller]")]
    public class image_to_pdf : ControllerBase
    {
        ...
        public async Task<IActionResult> convert_image_to_pdf([FromForm] FileModel model)
        {
            try
            {
                ...
                var task = lovePdfAPi.CreateTask<ImageToPdfTask>();
                FileRecord file = await SaveFileAsync(model.MyFile);
