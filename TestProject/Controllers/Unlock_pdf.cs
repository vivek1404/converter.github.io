...
namespace TestProject.Controllers
{
    ...
    public class unlock_pdf : ControllerBase
    {
        ...
        public async Task<IActionResult> convert_unloock_pdf([FromForm] FileModel model)
        {
            try
            {
                ...
                var task = lovePdfAPi.CreateTask<UnlockTask>();
                FileRecord file = await SaveFileAsync(model.MyFile);
